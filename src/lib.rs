...
pub struct WeatherResponse {
    pub weather: Vec<Weather>, // Contains weather information
    pub main: Main, // Contains main weather parameters
    pub wind: Wind, // Contains wind information
    pub name: String, // Contains the name of the queried location
}

// Struct to represent weather description
#[derive(Deserialize, Debug)]
pub struct Weather {
    pub description: String, // Contains textual weather description
}

// Struct to represent main weather parameters
#[derive(Deserialize, Debug)]
pub struct Main {
    pub temp: f64, // Temperature in Celsius
    pub humidity: f64, // Humidity in percentage
    pub pressure: f64, // Atmospheric pressure in hPa
}

// Struct to represent wind information
#[derive(Deserialize, Debug)]
pub struct Wind {
    pub speed: f64, // Wind speed in meters per second
}
